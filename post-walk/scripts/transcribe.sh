...
STARTUPS_ENV="/Users/ohong/dev/startups-rip/.env"
STARTUPS_ENV_LOCAL="/Users/ohong/dev/startups-rip/.env.local"
BAKE_OFF_ENV_LOCAL="/Users/ohong/dev/bake-off/.env.local"
